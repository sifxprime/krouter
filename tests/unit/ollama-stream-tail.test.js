...
// translator/index.js registers translators via require() for the bundler, which is a
// no-op under vitest. Importing the module runs its register() side effect so this
// test exercises the real ollama->openai conversion rather than raw passthrough.
