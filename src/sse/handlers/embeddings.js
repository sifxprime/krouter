...
// 0.5.121 (upstream c85a5c57) — only persist provider-reported embedding usage
// that is exact (real prompt tokens, no completion, total == prompt, not
// estimated). Anything else is a guess we shouldn't record as truth.
