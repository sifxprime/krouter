...
export const APIKEY_PROVIDERS = {
  ...
  // 0.5.98 — Featherless (upstream 0d4d4bc2): OpenAI-compatible, DeepSeek/GLM/Kimi presets.
  featherless: { id: "featherless", alias: "fl", name: "Featherless", icon: "flutter_dash", color: "#111827", textIcon: "FL", website: "https://featherless.ai", notice: { apiKeyUrl: "https://featherless.ai/account/api-keys" }, serviceKinds: ["llm"] },
  // 0.5.98 — Venice AI (upstream ab5ec52f): OpenAI-compatible, privacy-first.
  venice: { id: "venice", alias: "venice", name: "Venice AI", icon: "shield", color: "#DC2626", textIcon: "VE", website: "https://venice.ai", notice: { apiKeyUrl: "https://venice.ai/settings/api" }, serviceKinds: ["llm"] },
  // 0.5.98 — Perplexity Agent API (upstream ce6bdf7f): separate from search-focused Perplexity above; targets the /v1/responses agent endpoint.
  "perplexity-agent": { id: "perplexity-agent", alias: "perplexity-agent", name: "Perplexity Agent", image: "/providers/perplexity.png", icon: "travel_explore", color: "#20808D", textIcon: "PA", website: "https://www.perplexity.ai", notice: { apiKeyUrl: "https://www.perplexity.ai/settings/api" }, serviceKinds: ["llm"] },
