...
export const APIKEY_PROVIDERS = {
  ...
  "perplexity-agent": { id: "perplexity-agent", alias: "perplexity-agent", name: "Perplexity Agent", icon: "travel_explore", color: "#20808D", textIcon: "PA", website: "https://www.perplexity.ai", notice: { apiKeyUrl: "https://www.perplexity.ai/settings/api" }, serviceKinds: ["llm"] },
